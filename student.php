...
<body>
    <?php
        ...
        $result_sql=mysqli_query($conn,"SELECT `sub1`, `sub2`, `sub3`, `sub4`, `sub5`, `marks`, `percentage` FROM `result` WHERE `rno`='$rn' and `class`='$class'");
        ...
        <div class="main2">
            <table>
                ...
                <tbody>
                  <tr>
                    <td> 1 </td>
                    <td colspan="10">Subject 1 </td>
                    <td> <?php echo '<p>'.$p1.' / 100</p>';?> </td>
                  </tr>
                
                  <tr>
                    <td> 2 </td>
                    <td colspan="10">Subject 2 </td>
                    <td> <?php echo '<p>'.$p2.' / 100</p>';?></td>
                  </tr>
            
                  <tr>
                    <td> 3 </td>
                    <td colspan="10">Subject 3 </td>
                    <td> <?php echo '<p>'.$p3.' / 100</p>';?> </td>
                  </tr>
            
                  <tr>
                    <td> 4 </td>
                    <td colspan="10">Subject 4 </td>
                    <td> <?php echo '<p>'.$p4.' / 100</p>';?> </td>
                  </tr>
            
                  <tr>
                    <td> 5 </td>
                    <td colspan="10">Subject 5 </td>
